...
class AuditLog:
    ...
    ACTION_DOCUMENT_ASSIGNED = 'DOCUMENT_ASSIGNED'
    ACTION_ROLES_UPDATED = 'ROLES_UPDATED'
    ACTION_DASHBOARD_ERROR = 'DASHBOARD_ERROR'
    # New action types for CRUD and versioning
    ACTION_CREATE_DOCUMENT = 'CREATE'
    ACTION_EDIT_DOCUMENT = 'EDIT'
    ACTION_DELETE_DOCUMENT = 'DELETE'
    ACTION_RESTORE_DOCUMENT = 'RESTORE'
