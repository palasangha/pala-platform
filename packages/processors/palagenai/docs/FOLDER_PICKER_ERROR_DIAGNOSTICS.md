...
- If you're on `https://palagenai.com`, it becomes `https://palagenai.com/api`
...
- ❌ API is pointing to wrong server (palagenai.com instead of localhost)
- ❌ No valid auth token for palagenai.com
...
- Check the full URL
- It should show `https://palagenai.com/api/...`
...
- On `palagenai.com`, `/api` correctly refers to `https://palagenai.com/api`
...
- **Production**: `VITE_API_URL=/api` (or `https://palagenai.com/api`)
