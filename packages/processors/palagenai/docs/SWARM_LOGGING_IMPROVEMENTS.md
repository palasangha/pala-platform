...
```
[SWARM] Creating service - name: test-service, image: registry.palagenai.com:7103/gvpocr-worker:latest, replicas: 1
[SWARM] Validating service name: test-service
[SWARM] Original image: registry.palagenai.com:7103/gvpocr-worker:latest
[SWARM] Removed https:// prefix: registry.palagenai.com:7103/gvpocr-worker:latest
