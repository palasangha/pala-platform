...
class Config:
    ...
    GOOGLE_REDIRECT_URI = os.getenv('GOOGLE_REDIRECT_URI', 'http://localhost:7000/api/auth/google/callback')
    ...
    # CORS
    CORS_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:7002').split(',')
