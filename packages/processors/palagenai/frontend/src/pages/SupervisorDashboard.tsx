              ...
              <div className="border-t pt-4 mt-4">
                ...
                <div className="bg-gray-900 text-gray-100 p-4 rounded font-mono text-xs space-y-3 overflow-x-auto">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 break-all">docker build -f worker.Dockerfile -t registry.palagenai.com:7103/gvpocr-worker-updated:latest .</code>
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText('docker build -f worker.Dockerfile -t registry.palagenai.com:7103/gvpocr-worker-updated:latest .');
                        }}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 break-all">docker push registry.palagenai.com:7103/gvpocr-worker-updated:latest</code>
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText('docker push registry.palagenai.com:7103/gvpocr-worker-updated:latest');
                        }}
                        className="text-blue-400 hover:text-blue-300 whitespace-nowrap text-xs"
                      >
                        Copy
