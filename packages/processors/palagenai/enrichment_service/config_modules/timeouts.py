...
TOOL_TIMEOUTS: Dict[str, int] = {
    ...
    # Phase 3: Historical context with Ollama (much faster than Claude Opus)
    "research_historical_context": 120,
    "generate_biographies": 90,
    "assess_significance": 90,
    "extract_relationships": 120,
